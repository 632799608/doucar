        ...
        var abackList = new Vue({
            ...
            methods: {
                ...
                list: function() {
                    ...
                    var _this = this;
                    axios.post(Aizxin.U('message/back/index'), this.search)
                        .then(function(response) {
                            if (response.data.code == 200) {
                                _this.$set('back', response.data.data.data);
                            }
                ...
                elDelete: function(id) {
                    ...
                    layer.confirm('确认是否删除', {
                        ...
                        axios.delete(Aizxin.U('message/back') + '/' + id).then(function(response) {
                            if (response.data.code == 200) {
