        ...
        var aschoolList = new Vue({
            ...
            methods: {
                ...
                list: function() {
                    ...
                    var _this = this;
                    axios.post(Aizxin.U('approve/school/index'), this.search)
                        .then(function(response) {
                            if (response.data.code == 200) {
                                _this.$set('schoolapprove', response.data.data.data);
                            }
                ...
                elDelete: function(id) {
                    ...
                    layer.confirm('确认是否删除', {
                        ...
                        axios.delete(Aizxin.U('approve/school') + '/' + id).then(function(response) {
                            if (response.data.code == 200) {
