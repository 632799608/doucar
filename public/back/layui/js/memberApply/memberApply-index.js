        ...
        var aschoolList = new Vue({
            ...
            methods: {
                ...
                list: function() {
                    ...
                    var _this = this;
                    axios.post(Aizxin.U('member/apply/index'), this.search)
                        .then(function(response) {
                            console.log(response.data.data.data);
                            if (response.data.code == 200) {
                                _this.$set('memberapply', response.data.data.data);
                            }
                ...
                elDelete: function(id) {
                    ...
                    layer.confirm('确认是否删除', {
                        ...
                        axios.delete(Aizxin.U('member/apply') + '/' + id).then(function(response) {
                            if (response.data.code == 200) {
