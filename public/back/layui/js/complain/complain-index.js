        ...
        var acomplainList = new Vue({
            ...
            methods: {
                ...
                list: function() {
                    ...
                    var _this = this;
                    axios.post(Aizxin.U('message/complain/index'), this.search)
                        .then(function(response) {
                            if (response.data.code == 200) {
                                _this.$set('complain', response.data.data.data);
                            }
                ...
                elDelete: function(id) {
                    ...
                    layer.confirm('确认是否删除', {
                        ...
                        axios.delete(Aizxin.U('message/complain') + '/' + id).then(function(response) {
                            if (response.data.code == 200) {
