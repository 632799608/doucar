...
use Aizxin\Services\Admin\SchoolCommentService;

class SchoolCommentController extends Controller
{

    protected $service;
    public function __construct(SchoolCommentService $service)
    {
    ...
    public function index(Request $request)
    {
        ...
        return view('admin.schoolComment.index',compact('schoolList'));
    }
    /**
     *  [changeSwitch 驾校上架下架]
     *  臭虫科技
