...
use Aizxin\Repositories\Contracts\SchoolCommentRepository;
use Aizxin\Models\SchoolComment;
use DB;
/**
 *  驾校接口实现
 */
class SchoolCommentRepositoryEloquent extends BaseRepository implements SchoolCommentRepository
{
    /**
    ...
    public function index($pageSize)
    {
        return $this->orderBy('id','desc')
                ...
                ])->paginate($pageSize,['id','memberId', 'schoolId','comment','star','status'])->toArray();
    }
        /**
