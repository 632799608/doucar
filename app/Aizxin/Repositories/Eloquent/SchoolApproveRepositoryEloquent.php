...
use Aizxin\Repositories\Contracts\SchoolApproveRepository;
use Aizxin\Models\SchoolApprove;
use Aizxin\Tools\QiniuUpload;
/**
 *  驾校认证接口实现
 */
class SchoolApproveRepositoryEloquent extends BaseRepository implements SchoolApproveRepository
{
    /**
