...
@endsection
@section('content')
<div class="layui-body site-demo" id="waypointCategoryList">
            ...
            <div class="container-fluid larry-wrapper">
                ...
                <section class="panel panel-padding">
                	<div class="group-button">
                        <button class="layui-btn layui-btn-small" id="btn-showwaypoint">
    ...
    <div class="site-demo-result">
        <div class="layui-tab-content" style="padding: 16px;">
        	<div class="container-fluid larry-wrapper">
	            <section class="panel panel-padding">
			        <form class="layui-form" id="WaypointCategoryReset">
			            ...
			            <div class="layui-form-item">
			                <div class="layui-input-block">
			                    <button class="layui-btn" lay-submit="" lay-filter="addWaypointCategory">立即提交</button>
...
<script>
    layui.extend({
        'waypoint-category': 'js/waypoint/waypoint-category'
    }).use(['waypoint-category']);
</script>
@endsection
