            ...
            <form class="layui-form" style="padding: 17px;">
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        <input type="text" name="name" lay-verify="required" autocomplete="off" placeholder="{!!trans('admin/question.placeholder.name')!!}" class="layui-input layui-layedit">
                    </div>
                </div>
                <div class="layui-form-item">
                    ...
                    <div class="layui-inline">
                        ...
                        <div class="layui-input-inline">
                            <select name="questionType" lay-verify="required" lay-search="" lay-filter="questionType">
                                ...
                                <option value="1">{!!trans('admin/question.pduo')!!}</option>
                                <option value="2">{!!trans('admin/question.one')!!}</option>
                                <option value="3">{!!trans('admin/question.duo')!!}</option>
                            </select>
                        </div>
                    </div>
                </div>
                <div class="layui-form-item">
                    <div class="layui-inline">
                        ...
                        <div class="layui-input-inline">
                            <input type="text" name="difficulty" lay-verify="required" autocomplete="off" placeholder="{!!trans('admin/question.placeholder.difficulty')!!}" class="layui-input">
                        </div>
                    </div>
                </div>
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        ...
                        <div class="question-upload" style="margin-top: 5px;">
                            ...
                            <img id="LAY_question_upload" src="{{ asset('back/images/no-image.png') }}">
                        </div>
                    </div>
                </div>
                ...
                <fieldset class="layui-elem-field layui-field-title" id="adAnhtml">
                ...
                <div class="layui-form-item">
                    <div class="layui-input-block">
                        <button class="layui-btn" lay-submit="" lay-filter="addquestionstore">{!!trans('admin/setting.save')!!}</button>
...
<div id="addAnswerhtml" style="display: none">
    <section class="panel panel-padding">
...
<script>
    layui.extend({
        'question-add': 'js/question/question-add'
    }).use(['question-add']);
</script>
@endsection
