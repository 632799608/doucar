...
@endsection
@section('content')
<div class="layui-body site-demo" id="questionCategoryList">
    ...
    <div class="site-demo-result">
        <div class="layui-tab-content" style="padding: 16px;">
        	<div class="container-fluid larry-wrapper">
	            <section class="panel panel-padding">
			        <form class="layui-form" id="QuestionCategoryReset">
			            ...
			            <div class="layui-form-item">
			                <div class="layui-inline">
			                    ...
			                    <div class="layui-input-inline">
			                        <select name="type" id="acselect" lay-verify="required" lay-search="">
			            ...
			            <div class="layui-form-item">
			                <div class="layui-input-block">
			                    <button class="layui-btn" lay-submit="" lay-filter="addQuestionCategory">立即提交</button>
...
<script>
    layui.extend({
        'question-category': 'js/question/question-category'
    }).use(['question-category']);
</script>
@endsection
