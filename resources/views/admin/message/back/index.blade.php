...
@endsection
@section('content')
<div class="layui-body site-demo" id="backlist">
                    ...
                    <table id="example" class="layui-table lay-even">
                        <thead>
                            <tr>
                                ...
                                <th width="15">{!!trans('admin/back.model.id')!!}</th>
                                <th>{!!trans('admin/back.model.member')!!}</th>
                                <th>{!!trans('admin/back.model.phone')!!}</th>
                                <th>{!!trans('admin/back.model.content')!!}</th>
                                <th>{!!trans('admin/back.model.created_at')!!}</th>
                        ...
                        <tbody style="display: none">
                            <tr v-for="vo in back">
                                ...
                                <td width="152">
                                    ...
                                    @permission('message.back.destroy')
