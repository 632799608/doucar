                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-inline">
                        <select name="cheatCategoryId" lay-verify="required" lay-search="">
                            {!!$menuPresenter->topMenuList(trans('admin/cheat.menu'),$category,$cheat->cheatCategoryId)!!}
                        </select>
                    </div>
                </div>
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-inline">
                        <input type="text" name="name" lay-verify="required" autocomplete="off" placeholder="{!!trans('admin/cheat.placeholder.name')!!}" value="{{$cheat->name}}" class="layui-input">
                    </div>
                </div>
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block" style="margin-top: 10px;" id="thumb-upload">
                        @if (count($cheat->gallery) > 0)
                        @foreach ($cheat->gallery as $gallery)
                        <div class="imgbox">
                            <i class="fa fa-close i-delete"></i>
                            <img src="{{$gallery->thumb}}" class="img-thumbnail" />
                        </div>
                        @endforeach
                        @endif
                    </div>
                ...
                <div class="layui-form-item layui-form-text" style="margin-top: 10px;">
                    ...
                    <div class="layui-input-block">
                        <div class="content-cheat" style="margin-bottom: 20px;">
                            <textarea class="layui-textarea" name="overview" lay-verify="required">{{$cheat->overview}}</textarea>
                        </div>
                    </div>
                </div>
                <div class="layui-form-item layui-form-text" style="margin-top: 10px;">
                    ...
                    <div class="layui-input-block">
                        <div class="content-cheat" style="margin-bottom: 20px;">
                            <div id="cheat-content">{!!$cheat->content!!}</div>
                        </div>
                    </div>
                </div>
                <div class="layui-form-item">
                    <div class="layui-input-block">
                        <button class="layui-btn" lay-submit="" lay-filter="editcheatupdate">{!!trans('admin/setting.resave')!!}</button>
...
<script>
    ...
    }).use(['cheat-add'],function(){
        var conot = '{{ count($cheat->gallery) }}';
        if(conot > 0 ){
            $('#thumb-upload').show();
        }
    });
